...
var phoneBookFilePath = 'phonebook.json';
    ...
    return new Promise(function (resolve, reject) {
        rl.question('Enter phone number: ', function (phoneNumber) {
            rl.question('Enter name: ', function (name) {
                ...
                var existingEntry = phoneBook.find(function (entry) { return entry.phoneNumber === phoneNumber; });
                if (existingEntry) {
                    console.log('Error: Phone number already exists.');
                    console.log("Name: ".concat(existingEntry.name));
                    reject();
                }
                else {
...
function loadPhoneBook() {
    try {
        var data = fs.readFileSync(phoneBookFilePath, 'utf-8');
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, createPhoneBookEntry()];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
